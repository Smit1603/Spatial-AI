...
manipLeft1 = pipeline.create(dai.node.ImageManip)
manipRight1 = pipeline.create(dai.node.ImageManip)
...
nnL.passthrough.link(manipLeft1.inputImage)
nnR.passthrough.link(manipRight1.inputImage)

manipLeft1.initialConfig.setResize(640,400)
manipRight1.initialConfig.setResize(640,400)

manipLeft1.out.link(depth.left)
manipRight1.out.link(depth.right)
